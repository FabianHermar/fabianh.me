...
export default function ContactForm() {
	return (
		<div
			className='text-gray-800 flex min-h-screen flex-col bg-white pt-6 md:pt-0 lg:flex-row'
			id='contact'
		>
				...
				<div className='mb-8 lg:mb-0'>
					...
					<div className='hidden pt-10 md:block'>
						...
						<p className='font-GilroyRegular text-base'>
							...
							debajo. En todas siempre estaré con el gusto de poder atenderte.{' '}
						</p>
						<div className='flex flex-row items-center gap-x-3 pt-3'>
							<a href='https://x.com/FabianHermar' target='_blank' rel='noreferrer'>
								<svg
							...
							<a href='https://www.linkedin.com/in/fabianhmz' target='_blank' rel='noreferrer'>
								<svg
							...
							<a
								href='https://discord.com/users/607805987541352468'
								target='_blank'
								rel='noreferrer'
							>
								<svg
			...
			<div className='flex w-full flex-col items-center justify-center md:p-8 lg:w-1/2'>
				...
				<div className='block border-t border-neutral-200 pt-4 md:hidden'>
					<h3 className='mb-4 font-GilroyBold text-3xl font-bold md:text-4xl'>
						Más formas de contacto
					</h3>
					<p className='font-GilroyRegular text-base'>
					...
					<div className='flex flex-row items-center gap-x-3 pt-3'>
						...
						<a href='https://discord.com/users/607805987541352468' target='_blank' rel='noreferrer'>
							<svg
								fill='none'
								viewBox='0 0 50 50'
								width='36'
